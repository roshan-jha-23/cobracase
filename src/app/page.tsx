        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-col-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
            ...
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  ...
                  <img src="/users/user-5.jpg" alt="user image" className="inline-block h-10 w-10 object-cover rounded-full ring-2 ring-slate-100" />
                </div>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="realtive md:max-w-xl">
              <img src="/your-image.png" className="absolute w-40 lg:2-52 left-56 select-none hidden sm:block lg:hidden xl:block" alt="" />
